    ...
    public class Manager
    {
        ...
        public Manager()
        {
            ...
            var config = new MapperConfiguration(cfg =>
            {
                ...
                cfg.CreateMap<Controllers.ArtistAddForm, Controllers.ArtistAdd>();
                ...
                cfg.CreateMap<Controllers.TrackWithDetails, Controllers.TrackEditInfoForm>();


                cfg.CreateMap<Models.Track, Controllers.TrackMedia>();
        ...
        public AlbumWithDetails AlbumGetIdWithDetails(int? id)
        {
        ...
        public TrackWithDetails TrackGetIdWithDetails(int? id)
        {
            var o = ds.Tracks.Include("Albums").SingleOrDefault(a => a.Id == id);
        ...
        public TrackBase TrackAdd(TrackAdd newItem)
        {
            ...
            addedItem.Media = mediaBytes;
            addedItem.MediaContentType = newItem.MediaUpload.ContentType;
        ...
        public TrackWithDetails TrackEditInfo(TrackEditInfo newItem)
        {
            ...
            o.Media = mediaBytes;
            o.MediaContentType = newItem.MediaUpload.ContentType;
        ...
        // Media Handle
        public TrackMedia MediaGetById(int? id)
        {
            var o = ds.Tracks.Find(id.GetValueOrDefault());

            return (o == null) ? null : mapper.Map<Track, TrackMedia>(o);
        }

        public bool TrackDelete(int? id)
        {
            var trackToDelete = ds.Tracks.Find(id.GetValueOrDefault());
